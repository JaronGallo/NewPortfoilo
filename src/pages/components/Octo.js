                    ...
                    <div className="row container" >
                        <div className="col s12" style={{ marginTop: '3em',paddingLeft: '0'  }}>
                            ...
                            <p className="aboutHeading">OBJECTIVE</p>
                                <p>Implement user authientcation using Google and Facebook into our final group project. After being authenticated, taking the user to our page with all of the videos</p>
                                <br/>
                                <p className="aboutHeading" style={{marginBottom:'0'}}>CHALLENGE</p>
                                <p>Given a 4 week window to finish the project, I knew how to use Facebook and Google authencation but not in React. I first built the auth using regular JavaScript but had a hard time getting it to connect to our React site. I ended up having to re-code the whole thing in order to be compatable. </p>
                               <br/>
